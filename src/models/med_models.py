...
class Appointment(Base):
    ...
    med_service_id: Mapped[int] = mapped_column(ForeignKey('med_services.id'), ondelete="CASCADE")
...
class Patient(Base):
    ...
    appointment: Mapped[list["Appointment"]] = relationship(backpopulates="patient", cascade="all, delete-orphan")
...
class MedService(Base):
    ...
    appointment: Mapped[list["Appointment"]] = relationship(backpopulates="med_service",
